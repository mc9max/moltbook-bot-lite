...
<style>body{font-family:system-ui;max-width:1200px;margin:2rem auto;padding:0 1rem;background:#0f1117;color:#e6e6e6}
...
th{cursor:pointer;user-select:none;white-space:nowrap;overflow-wrap:normal}th:hover{color:#ff6a3d}th .arrow{font-size:.7rem;opacity:.7}
